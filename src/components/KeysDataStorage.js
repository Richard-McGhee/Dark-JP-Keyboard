...
let keyDataInRowsObjectsWithKeyArrays = [
    ...
    [
        ...
        [{id: ">", chars: [">", ".", "る", "。"]}],
        [{id: "?", chars: ["?", "/", "め", "・"]}],
        [{id: "R.Shift", chars: ["R.Shift"]}]
    ],
    // Last row of Keys, mirroring the keyboard layout
    [
        [{id: "L.Ctrl", chars: ["L.Ctrl"]}],
        [{id: "Win", chars: ["Win"], alt: "L.Alt"}],
        [{id: "L.Alt", chars: ["L.Alt"], alt: "None or Space"}],
        [{id: "Spacebar", chars: ["Spacebar"]}],
        [{id: "R.Alt", chars: ["R.Alt"]}],
        // [{id: "R.Ctrl", chars: ["R.Ctrl"], alt: "R.Win"}],
        [{id: "Fn", chars: ["Fn"], alt: "L.Win"}],
        [{id: "Menu", chars: ["Menu"]}],
        [{id: "R.Ctrl", chars: ["R.Ctrl"]}]
    ]        
]
